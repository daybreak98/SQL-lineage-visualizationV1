insert overwrite table ihotel_default.dw_ihotel_abtest_index_searchlist_di partition (dt='${zdt.addDay(-1).format("yyyy-MM-dd")}', type = 'order',user_id_type='uid')
...
on a.ab_exp_value = order.order_orig_device_id
