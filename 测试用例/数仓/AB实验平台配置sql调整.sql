...
'${item}'<#if item_has_next>,</#if>
    ...
    base_is_big_order_user as (
     ...
     search_result as (
         ...
         from search_src a
             <#if is_big_order_user?exists>
         left join base_is_big_order_user base on a.user_id = base.user_id
...
select
    ...
    round(a.top1_order_pv / a.order_num, 6) as top1_booking_share_pv, -- TOP1预定命中率_PV
    round(a.top3_click_pv / a.click_pv, 6) as top3_click_share_pv, -- TOP3点击命中率_PV
    round(a.top3_order_pv / a.order_num, 6) as top3_booking_share_pv, -- TOP3预定命中率_PV
    round(a.top5_click_pv / a.click_pv, 6) as top5_click_share_pv, -- TOP5点击命中率_PV
    round(a.top5_order_pv / a.order_num, 6) as top5_booking_share_pv, -- TOP5预定命中率_PV
    round(a.top10_click_pv / a.click_pv, 6) as top10_click_share_pv, -- TOP10点击命中率_PV
    round(a.top10_order_pv / a.order_num, 6) as top10_booking_share_pv, -- TOP10预定命中率_PV
