...
select
    a.datee
     ...
     ,concat(round(a.top1_order_pv/a.order_pv*100,2),'%') as `TOP1预定命中率_PV`
     ...
     ,concat(round(a.top5_order_pv/a.order_pv*100,2),'%') as `TOP5预定命中率_PV`
     ,concat(round(a.top10_click_pv/a.click_pv*100,2),'%') as `TOP10点击命中率_PV`
     ,concat(round(a.top10_order_pv/a.order_pv*100,2),'%') as `TOP10预定命中率_PV`
